...
export const users: User[] = [
  ...
  },
  {
    ...
    department: 'HRD팀',
    phone: '010-9876-5432',
    email: 'manager@equalkey.com',
    hrdPoints: 580
  },
  { id: 'u1', name: '김깨다', employeeId: 'EK003', position: '사원', department: '영업팀', phone: '010-1234-5678', email: 'queda@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u2', name: '이챌리', employeeId: 'EK004', position: '대리', department: '기획팀', phone: '010-2345-6789', email: 'chaeli@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u3', name: '박따미', employeeId: 'EK005', position: '과장', department: '분석팀', phone: '010-3456-7890', email: 'sweatie@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u4', name: '최분수', employeeId: 'EK006', position: '차장(팀장)', department: '전략팀', phone: '010-4567-8901', email: 'fractoin.choi@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u5', name: '정곱셈', employeeId: 'EK007', position: '사원', department: '교육팀', phone: '010-5678-9012', email: 'multi.jung@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u6', name: '오미분', employeeId: 'EK008', position: '대리', department: '품질팀', phone: '010-6789-0123', email: 'ohdiff@equalkey.com', role: 'student', hrdPoints: 0 },
  ...
  { id: 'u8', name: '고도형', employeeId: 'EK010', position: '부장(본부장)', department: '경영지원팀', phone: '010-8901-2345', email: 'goshapes@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u9', name: '강적분', employeeId: 'EK011', position: '과장', department: 'R&D팀', phone: '010-9012-3456', email: 'integral.kang@equalkey.com', role: 'student', hrdPoints: 0 },
  { id: 'u10', name: '한차원', employeeId: 'EK012', position: '이사(그룹장)', department: '데이터팀', phone: '010-0123-4567', email: 'first.dimension@equalkey.com', role: 'student', hrdPoints: 0 },
];
...
export const curriculums: Curriculum[] = [
  {
    id: 'EQ-C01-001',
    code: 'EQ-C01-001',
    title: '슥 보면 딱 아는 리더의 남다른 수 감각',
    lessonCount: 30,
    period: '25.07.15~25.08.04',
    status: 'not_started',
    points: 0,
    modules: []
  },
  {
    id: 'EQ-C02-001',
    code: 'EQ-C02-001',
    title: '천리안으로 내다보는 리더의 남다른 예측력',
    lessonCount: 30,
    period: '25.06.05~25.06.24',
    status: 'not_started',
    points: 90,
    modules: []
  },
  {
    id: 'EQ-C03-001',
    code: 'EQ-C03-001',
    title: '일머리 좋은 신입 사원의 남다른 데이터 리터러시',
    lessonCount: 50,
    period: '25.05.01~25.06.09',
    status: 'not_started',
    points: 120,
    modules: []
  },
  { id: 'c1', code: 'c1', title: '동기부여와 성과관리', period: '2024.07.01~2024.07.31', status: 'in_progress', points: 80, lessonCount: 10, modules: [] },
  { id: 'c2', code: 'c2', title: '직무교육 A', period: '2024.06.15~2024.07.15', status: 'completed', completionDate: '2024.07.15', points: 100, lessonCount: 10, modules: [] },
  { id: 'c3', code: 'c3', title: '직무교육 B', period: '2024.07.01~2024.07.31', status: 'not_started', points: 0, lessonCount: 10, modules: [] },
  { id: 'c4', code: 'c4', title: '프로야구로 보는 코칭 리더십', period: '2024.08.01~2024.08.31', status: 'not_started', points: 0, lessonCount: 10, modules: [] },
  { id: 'c5', code: 'c5', title: '리더십 기초', period: '2024.07.10~2024.08.10', status: 'in_progress', points: 50, lessonCount: 10, modules: [] },
];

export const completedCurriculums: Curriculum[] = [
  {
    id: 'EQ-A01-001',
    code: 'EQ-A01-001',
    title: '동기부여와 성과관리',
    lessonCount: 15,
    period: '25.01.15~25.01.18',
    status: 'completed',
    completionDate: '25.01.16',
    points: 75,
    modules: []
  },
  {
    ...
    title: '직무교육 A',
    lessonCount: 20,
    period: '24.11.26~24.12.05',
    status: 'completed',
    completionDate: '24.12.02',
    points: 85,
    modules: []
  },
  {
    id: 'EQ-B01-001',
    code: 'EQ-B01-001',
    title: '프로야구로 보는 코칭 리더십',
    lessonCount: 10,
    period: '24.10.01~24.10.03',
    status: 'completed',
    completionDate: '24.10.03',
    points: 65,
    modules: []
  }
];
    ...
    modules: [
      {
        ...
        module_title: '단위 환산',
        lessons: [
          { lesson_id: 'lesson01', lesson_title: '8천, 9천, 그 다음은?', status: 'completed', lesson_completed_at: '25.07.16', progress: 100,
            quizzes: [
              {
          ...
          { lesson_id: 'lesson02', lesson_title: '12천, 12개의 천도복숭아', status: 'completed', lesson_completed_at: '25.07.17', progress: 100 },
